...
function addZero(num){
  ...
  const revTitleContainer = document.querySelector('.reviews__title-wrap');
  const revSliderContainer = document.querySelector('.reviews-slider');
  const targetBtns = document.querySelector('.reviews-slider-btns');
